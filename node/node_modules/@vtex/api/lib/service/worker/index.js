    ...
    if (routes && clients) {
        return Object.keys(routes).reduce((acc, routeId) => {
            ...
            if (publicRoute || extensible) {
                acc.pub[routeId] = {
                    handler: http_2.createPublicHttpRoute(clients, routes[routeId], serviceRoute, routeId, globalLimiter),
                    path: servicePath,
                };
            }
            else {
                acc.pvt[routeId] = {
                    handler: http_2.createPrivateHttpRoute(clients, routes[routeId], serviceRoute, routeId, globalLimiter),
        ...
        return {
            pvt: {
                [graphql_1.GRAPHQL_ROUTE]: {
                    handler: graphql_1.createGraphQLRoute(graphql, clients, route, graphql_1.GRAPHQL_ROUTE, globalLimiter),
...
const createAppEventHandlers = ({ config: { events, clients } }, serviceJSON, globalLimiter) => {
    if (events && clients) {
        return Object.keys(events).reduce((acc, eventId) => {
            ...
            acc[eventId] = events_1.createEventHandler(clients, eventId, events[eventId], serviceEvent, globalLimiter);
            return acc;
        }, {});
    }
    return null;
...
exports.startWorker = (serviceJSON) => {
    ...
    app
        ...
        .use(rateLimit_1.concurrentRateLimiter((_a = serviceJSON === null || serviceJSON === void 0 ? void 0 : serviceJSON.rateLimitPerReplica) === null || _a === void 0 ? void 0 : _a.concurrent))
    ...
    const globalLimiter = tokenBucket_1.createTokenBucket((_b = serviceJSON === null || serviceJSON === void 0 ? void 0 : serviceJSON.rateLimitPerReplica) === null || _b === void 0 ? void 0 : _b.perMinute);
