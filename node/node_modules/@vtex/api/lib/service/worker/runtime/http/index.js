...
exports.createPrivateHttpRoute = (clientsConfig, serviceHandler, serviceRoute, routeId, globalLimiter) => {
    var _a, _b;
    ...
    const pipeline = [
        ...
        timings_1.timings,
        rateLimit_1.concurrentRateLimiter((_a = serviceRoute === null || serviceRoute === void 0 ? void 0 : serviceRoute.rateLimitPerReplica) === null || _a === void 0 ? void 0 : _a.concurrent),
        rateLimit_1.perMinuteRateLimiter((_b = serviceRoute === null || serviceRoute === void 0 ? void 0 : serviceRoute.rateLimitPerReplica) === null || _b === void 0 ? void 0 : _b.perMinute, globalLimiter),
        tracingMiddlewares_1.traceUserLandRemainingPipelineMiddleware(),
        ...middlewares,
    ];
    return compose_1.compose(pipeline);
};
exports.createPublicHttpRoute = (clientsConfig, serviceHandler, serviceRoute, routeId, globalLimiter) => {
    var _a, _b;
    const { implementation, options } = clientsConfig;
    const middlewares = toArray_1.toArray(serviceHandler);
    const pipeline = [
